# Secure OpenClaw Setup for Mac (Sandboxed)

## 1. Install Prerequisites
Check if Docker is already installed. If `docker --version` returns a version number, skip to Step 2.

Run these commands in your terminal to install Homebrew and Docker, and prepare your environment.
...
# On Docker Desktop for Mac, this is often handled automatically, but running this ensures correct permissions.
